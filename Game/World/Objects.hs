...
objectAnimation 1 South = a1
    where
        ...
        a2 = Animation 1 "PlayerS2" 0.25 a3 0
        a3 = Animation 1 "PlayerS3" 0.25 a4 0
        a4 = Animation 1 "PlayerS4" 0.25 a1 0

objectAnimation 1 North = b1
    where
        b1 = Animation 2 "PlayerN1" 0.25 b2 0
        b2 = Animation 2 "PlayerN2" 0.25 b3 0
        b3 = Animation 2 "PlayerN3" 0.25 b4 0
        b4 = Animation 2 "PlayerN4" 0.25 b1 0

objectAnimation 1 West = c1
    where
        c1 = Animation 3 "PlayerW1" 0.25 c2 0
        c2 = Animation 3 "PlayerW2" 0.25 c3 0
        c3 = Animation 3 "PlayerW3" 0.25 c4 0
        c4 = Animation 3 "PlayerW4" 0.25 c1 0

objectAnimation 1 East = d1
    where
        d1 = Animation 4 "PlayerE1" 0.25 d2 0
        d2 = Animation 4 "PlayerE2" 0.25 d3 0
        d3 = Animation 4 "PlayerE3" 0.25 d4 0
        d4 = Animation 4 "PlayerE4" 0.25 d1 0
