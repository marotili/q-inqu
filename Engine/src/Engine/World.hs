...
import Engine.World.ObjectData
import Debug.Trace
...
import Data.Tiled
import Engine.World.Import.Tiled


import Engine.World.Delta
import Engine.World.Wires
import Engine.World.Common
import qualified Engine.World.Objects as World
...
data Arrow = Arrow
instance Spawnable Engine.World.Arrow where
